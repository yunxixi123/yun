...
\begin{document}
  \begin{titlepage}
    ...
    % \vspace*{0.2\fill}
    \vspace*{-20pt}
    \includegraphics[width=390pt, height=100pt]{ahu1}\\[80pt] % Change the school logo here (See the logo/ directory) and adjust the height
    ...
    {\textsf{\zihao{2} \heiti《数字电路与逻辑设计》\ 综\ 合\ 作\ 业}}\\[90pt]
 ...
 \songti
  ...
  \section{实验内容}
  一些麻瓜称，根据 NASA 的测算，由于天体运行导致
  
  地球的磁场和重力场发生变化，只有在2月10日当天扫帚才可以立起来。
  ...
  为了解决上述问题，我在实验中采用了先将扫帚毛从用手扶着竖直立在地上后，再进行调整的方式。
